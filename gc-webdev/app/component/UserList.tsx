    ...
    return (
        <div className='flex flex-col center items-center p-10'>
            <div className='center items-center'>
                <p className='font-bold text-[30px] text-purple-heavy mb-5'>전체 학생 관리</p>
                <p className='text-[23px] text-gray-30 mb-2 text-center'>Student list</p>
            </div>
                ...
                <table className='w-full'>
                    <thead className='bg-gray-10'>
                        <tr>
                            ...
                            <td className='px-2 pt-3 pb-2 text-[15px]'>생년월일 {/* date of birth (YYYY.mm.dd) */}</td>
                            <td className='px-2 pt-3 pb-2 text-[15px]'>전화번호 {/* mobile number */}</td>
                            <td className='px-2 pt-3 pb-2 text-[15px]'>성별 {/* gender */}</td>
                    ...
                    <tbody>
                        {users.map((user, index) => (
                            <tr key={index} className='border-b-1 border-gray-10'>
                                <td className='px-2 pt-3 pb-2 border-r-1 border-l-1 border-gray-10 text-[15px]'>{user.name}</td>
                                <td className='px-2 pt-3 pb-2 border-r-1 border-gray-10 text-[15px]'>{user.email}</td>
                                <td className='px-2 pt-3 pb-2 border-r-1 border-gray-10 text-[15px]'>{user.dateofbirth}</td>
                                <td className='px-2 pt-3 pb-2 border-r-1 border-gray-10 text-[15px]'>{user.mobilenumber}</td>
                                <td className='px-2 pt-3 pb-2 border-r-1 border-gray-10 text-[15px]'>{user.gender}</td>
